...
/**
 * Represents a complete contribution of one specific user to one specific survey.
 * It contains a list of Answer instances.
 */
@Entity
...
public class AnswerSet implements java.io.Serializable {
	...
	public String getMatrixAnswer(String questionUid, String answerUid) {
		for (Answer answer : answers)
		{
			...
			{
				if (answer.getQuestionUniqueId().equals(questionUid) && answer.getPossibleAnswerUniqueId().equals(answerUid))
				{
					return answer.getValue();
				}
			}
